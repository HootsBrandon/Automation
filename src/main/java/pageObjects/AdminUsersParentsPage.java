...
public class AdminUsersParentsPage {
	...
	By delete = By.cssSelector(
			"body > div.body-wrapper > div.ng-scope > div > div.admin-canvas.ng-scope > div > div > div.ng-scope > div > div > div > div > div.inner-table-container > table > tbody > tr:nth-child(2) > td.action.ng-scope > a.text-danger > span");
	...
	By previous = By.cssSelector(
			"body > div.body-wrapper > div.ng-scope > div > div.admin-canvas.ng-scope > div > div > div.ng-scope > div > div > div > div > div.table-footer > ul > li.pagination-prev.ng-scope.disabled > a");
